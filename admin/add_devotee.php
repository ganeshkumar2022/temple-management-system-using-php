...
<div class="row">
    <div class="col">
      ...
      <input type="text" class="form-control state-bor" id="email" name="devotee_name" required>
    </div>
    <div class="col">
      <label for="country">Date</label>
      <input type="date" class="form-control state-bor" id="email" name="bdate" required>
    </div>
</div>
<div class="row mt-4">
    <div class="col">
...
?>
  ...
  <button type="submit" class="btn button-color mt-3 text-white px-4 py-2" name="add_devotee">Submit</button>
