...
<div class="row">
    <div class="col">
      ...
      <input type="text" class="form-control state-bor" id="email" name="expense_type_name" required>
    </div>
    <div class="col">
      <label for="country">Date</label>
      <input type="date" class="form-control state-bor" id="email" name="edate" required>
    </div>
</div>
...
<div class="row mt-4"> 
    ...
    <div class="col">
      ...
      <input type="text" class="form-control state-bor" id="email" maxlength="10" name="amount" required>
    </div> 
   
</div>

  <button type="submit" class="btn button-color mt-3 text-white px-4 py-2" name="add_expense">Submit</button>
