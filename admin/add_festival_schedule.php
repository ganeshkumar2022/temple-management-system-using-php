...
<div class="row">
    <div class="col">
      ...
      <input type="text" class="form-control state-bor" id="email"  name="festival_name">
    </div>
    <div class="col">
    <label class="text-secondary">Date</label>
    <input type="date" class="form-control state-bor" id="email" name="date">
    </div>
  </div>
  <button type="submit" class="btn button-color mt-3 text-white px-4 py-2" name="add_festival_schedule">Submit</button>
