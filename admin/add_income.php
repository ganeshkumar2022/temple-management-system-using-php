...
<div class="row">
    <div class="col">
      ...
      <input type="text" class="form-control state-bor" id="email" name="receipt_no" required>
    </div>
    <div class="col">
      <label for="country">Date</label>
      <input type="date" class="form-control state-bor" id="email" name="rdate" required>
    </div>
</div>
...
if(mysqli_num_rows($result4)>0)
{
  ...
  {
    ?>
    <option value="<?=$row4['devotee_id']?>"><?=$row4["devotee_name"]?></option>
    <?php
  }
}
?>
...
<div class="row mt-4"> 
    <div class="col">
      ...
      <input type="text" class="form-control state-bor" id="email" maxlength="10" name="address" required>
    </div> 
    <div class="col">
...
if(mysqli_num_rows($result4)>0)
{
  ...
  {
    ?>
    <option value="<?=$row4['income_type_id']?>"><?=$row4["income_type_name"]?></option>
    <?php
  }
}
?>
...
<div class="row mt-4"> 
    <div class="col">
      ...
      <input type="number" class="form-control state-bor" readonly id="charge" maxlength="10" name="charge" required>
    </div> 
    <div class="col">
  ...
  <button type="submit" class="btn button-color mt-3 text-white px-4 py-2" name="add_income">Submit</button>
