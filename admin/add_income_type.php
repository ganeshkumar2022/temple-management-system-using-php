...
<div class="row">
    <div class="col">
      <input type="text" class="form-control state-bor" placeholder="Income type name" id="email"  name="income_type_name">
    </div>
    <div class="col">
   
    </div>
  </div>
  <button type="submit" class="btn button-color mt-3 text-white px-4 py-2" name="add_income_type">Submit</button>
