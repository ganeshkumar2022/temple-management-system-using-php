...
<div class="row">
    <div class="col">
      ...
      <input type="text" class="form-control state-bor" id="email" required name="seva_name">
    </div>
    <div class="col">
      <label for="state">Charge of Seva</label>
      <input type="number" class="form-control state-bor" maxlength="25" required name="charge" required id="state">
    </div>
  </div>
  <div class="row">
    <div class="col">
      <label for="country">No.of person</label>
      <input type="number" class="form-control state-bor" id="email" required name="no_of_person">
    </div>
    <div class="col">
    </div>
  </div>
  <button type="submit" class="btn button-color mt-3 text-white px-4 py-2" name="add_seva">Submit</button>
