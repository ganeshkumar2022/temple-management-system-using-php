...
<div class="row">
    <div class="col">
      ...
      <input type="text" class="form-control state-bor" id="email" name="staff_id" required>
    </div>
    <div class="col">
      <label for="country">Staff name</label>
      <input type="text" class="form-control state-bor" id="email" name="staff_name" required>
    </div>
</div>
<div class="row mt-4">
    <div class="col">
      <label for="country">Phone no</label>
      <input type="text" class="form-control state-bor" id="email" maxlength="10" name="phone" required>
    </div>
    <div class="col">
    <label for="country">Aadhar card no</label>
      <input type="text" class="form-control state-bor" id="email"  name="aadhar" required>
    </div>
</div>
<div class="row mt-4">
    <div class="col">
      <label for="country">Date of birth</label>
      <input type="date" class="form-control state-bor" id="email" required name="dob">
    </div>
    <div class="col">
  ...
  <div class="row mt-4">
    <div class="col">
      ...
      <input type="text" class="form-control state-bor" id="email" name="address" required>
    </div>
    <div class="col">
    </div>
  </div>
 
  <button type="submit" class="btn button-color mt-3 text-white px-4 py-2" name="add_staff">Submit</button>
