...
<div class="row">
    ...
    <div class="col">
      ...
      <input type="text" class="form-control state-bor" maxlength="25"  name="state" required id="state">
    </div>
  </div>
  <button type="submit" class="btn button-color mt-3 text-white px-4 py-2" name="add_state">Submit</button>
