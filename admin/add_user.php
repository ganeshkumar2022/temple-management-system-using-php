...
<h4><a href="manage_user.php" class="text-decoration-none text-dark">Add User</a></h4>
<div class="row">
    <div class="col">
      <label for="country">First name</label>
      <input type="text" class="form-control state-bor"  name="first_name" required>
    </div>
    <div class="col">
      <label for="country">Last name</label>
      <input type="text" class="form-control state-bor"  name="last_name" required>
    </div>
</div>
<div class="row mt-4">
    <div class="col">
      <label for="country">Email</label>
      <input type="email" class="form-control state-bor"  name="email" required>
    </div>
    <div class="col">
    <label for="country">Password</label>
      <input type="password" class="form-control state-bor"  name="password" required>
    </div>
</div>
<div class="row mt-4">
    <div class="col">
...
if(mysqli_num_rows($result5)>0)
{
    ...
    {
        ?>
        <option value="<?=$row5['role_name']?>"><?=$row5["role_name"]?></option>
        <?php
    }
}
?>
  ...
  <button type="submit" class="btn button-color mt-3 text-white px-4 py-2" name="add_user">Submit</button>
