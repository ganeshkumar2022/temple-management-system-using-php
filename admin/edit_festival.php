...
$obj=new festival();
$states=$obj->get_festival_id($_GET["id"]);
?>
<!-- header end -->
...
<h4><a href="manage_festival_schedule.php" class="text-decoration-none text-dark">Schedule of festival</a></h4>
<div class="row">
    <div class="col">
        <label class="text-secondary">Festival name</label>
      <input type="text" class="form-control state-bor" id="email" value="<?=$states['festival_name']?>"  name="festival_name">
    </div>
    <div class="col">
    <label class="text-secondary">Date</label>
    <input type="date" class="form-control state-bor" id="email" name="date" value="<?=$states['festival_date']?>">
    </div>
  </div>
  <button type="submit" class="btn button-color mt-3 text-white px-4 py-2" name="edit_festival_schedule">Submit</button>
