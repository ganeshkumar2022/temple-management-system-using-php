...
$obj=new state();
$state=$obj->getstateById($_GET["id"]);
?>
...
<h3><a href="manage_states.php" class="text-decoration-none text-dark">States</a></h3>
<div class="row">
    <div class="col">
    ...
    <div class="col">
      ...
      <input type="text" class="form-control state-bor" maxlength="25" value="<?=$state['state_name']?>" name="state_name" required id="state">
    </div>
  </div>
  <button type="submit" class="btn button-color mt-3 text-white px-4 py-2" name="edit_state">Submit</button>
