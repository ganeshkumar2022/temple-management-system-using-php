...
<h4><a class="text-decoration-none text-dark">Expense reports</a></h4>
<div class="row">
    <div class="col">
  ...
  <button type="submit" class="btn button-color mt-3 text-white px-4 py-2" name="expense_reports">Search</button>
...
<?php
if(isset($_POST["expense_reports"]))
{
