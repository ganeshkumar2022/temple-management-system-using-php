...
<h4><a class="text-decoration-none text-dark">Income reports</a></h4>
<div class="row">
    <div class="col">
  ...
  <button type="submit" class="btn button-color mt-3 text-white px-4 py-2" name="income_reports">Search</button>
...
<?php
if(isset($_POST["income_reports"]))
{
    $from_date=$_POST["from_date"];
    $to_date=$_POST["to_date"];
    include("../db.php");
    $sql="select * from income inner join devotee on income.devotee_id=devotee.devotee_id where income.rdate between '$from_date' and '$to_date'";
