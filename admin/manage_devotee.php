...
<div class="card">
<div class="card-body">
<a href="add_devotee.php" class="btn button-color text-white px-4 py-2">Add</a>
<div class="row mt-3">
    <div class="col-md-12">
       <!-- table start -->
...
<tr>
    <td><?=$i?></td>
    <td><?=$state["devotee_name"]?></td>
    <td><?=$state["bdate"]?></td>
    <td><!--<a href="https://wa.me/91<?=$state['phone']?>?text=hi hello"><?=$state["phone"]?></a>-->
    <?=$state['phone']?>
    </td>
    <td>
        <?php
        ...
        {
            ?>
            <h5><span class="badge badge-pill badge-success"><?=$state["status"]?></span></h5>
            <?php
        }
        else
        {
            ?>
            <h5><span class="badge badge-pill badge-danger"><?=$state["status"]?></span></h5>
            <?php
        }
        ?>
    ...
    <td>
    <a href="edit_devotee.php?id=<?=$state['devotee_id']?>" id="ed-icon"><i class="fa-solid fa-pen-to-square"></i></a>
    <a href="delete_devotee.php?id=<?=$state['devotee_id']?>" id="del-icon"><i class="fa-solid fa-trash"></i></a>
    </td>
</tr>
<?php
$i++;
