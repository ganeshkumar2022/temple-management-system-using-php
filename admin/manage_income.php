...
<div class="card">
<div class="card-body">
<a href="add_income.php" class="btn button-color text-white px-4 py-2">Add</a>
<div class="row mt-3">
    <div class="col-md-12">
       <!-- table start -->
...
<tr>
    <td><?=$i?></td>
    <td><?=$state["receipt_no"]?></td>
    <td><?=$state["rdate"]?></td>
    <td><?=$state["devotee_name"]?></td>
    <td><?=$state["seva_name"]?></td>
    <td><a href="receiptpdf.php?id=<?=$state['in_id']?>" class="text-secondary">View Receipt</a></td>
    <td>
    <a href="edit_income.php?id=<?=$state['in_id']?>" id="ed-icon"><i class="fa-solid fa-pen-to-square"></i></a>
    &nbsp;&nbsp;
    <a href="delete_income.php?id=<?=$state['in_id']?>" id="del-icon"><i class="fa-solid fa-trash"></i></a>
    </td>
</tr>
<?php
$i++;
