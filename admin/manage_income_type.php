...
<div class="card">
<div class="card-body">
<a href="add_income_type.php" class="btn button-color text-white px-4 py-2">Add</a>
<div class="row mt-3">
    <div class="col-md-12">
       <!-- table start -->
...
<tr>
    <td><?=$i?></td>
    <td><?=$state["income_type_name"]?></td>
    <td>
    <a href="edit_income_type.php?id=<?=$state['income_type_id']?>" id="ed-icon"><i class="fa-solid fa-pen-to-square"></i></a>
    &nbsp;&nbsp;
    <a href="delete_income_type.php?id=<?=$state['income_type_id']?>" id="del-icon"><i class="fa-solid fa-trash"></i></a>
    </td>
</tr>
<?php
$i++;
