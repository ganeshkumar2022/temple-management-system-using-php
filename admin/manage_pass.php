...
<tr>
    <td><?=$i?></td>
    <td><?=$state["preading_time"]?></td>
    <td><?=$state["devotee_name"]?></td>
    <td><?=$state["seva_name"]?></td>
    <td><a href="paymentpdf.php?id=<?=$state['pass_id']?>">View pass</a></td>
    <td>
    <a href="delete_pass.php?id=<?=$state['pass_id']?>" id="del-icon"><i class="fa-solid fa-trash"></i></a>
    </td>
</tr>
<?php
$i++;
