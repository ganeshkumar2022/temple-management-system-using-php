...
<div class="card">
<div class="card-body">
<a href="add_salary.php" class="btn button-color text-white px-4 py-2">Add</a>
<div class="row mt-3">
    <div class="col-md-12">
       <!-- table start -->
...
<tr>
    <td><?=$i?></td>
    <td><?=$state["staff_name"]?></td>
    <td><?=$state["working_days"]?></td>
    <td><?=$state["per_day_salary"]?></td>
    <td><?=$state["working_days"]*$state["per_day_salary"]?></td>
    <td>
    <a href="edit_salary.php?id=<?=$state['salary_id']?>" id="ed-icon"><i class="fa-solid fa-pen-to-square"></i></a>
    &nbsp;&nbsp;
    <a href="delete_salary.php?id=<?=$state['salary_id']?>" id="del-icon"><i class="fa-solid fa-trash"></i></a>
    </td>
</tr>
<?php
$i++;
