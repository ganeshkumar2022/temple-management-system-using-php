...
<div class="card">
<div class="card-body">
<a href="add_schedule.php" class="btn button-color text-white px-4 py-2">Add</a>
<div class="row mt-3">
    <div class="col-md-12">
       <!-- table start -->
...
<tr>
    ...
    <td><?=$state["date"]?></td>
    <td>
    <a href="edit_schedule.php?id=<?=$state['schedule_id']?>" id="ed-icon"><i class="fa-solid fa-pen-to-square"></i></a>
    &nbsp;&nbsp;
    <a href="delete_schedule.php?id=<?=$state['schedule_id']?>" id="del-icon"><i class="fa-solid fa-trash"></i></a>
    </td>
</tr>
<?php
$i++;
