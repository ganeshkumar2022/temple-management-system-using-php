...
<div class="card">
<div class="card-body">
<a href="add_staff.php" class="btn button-color text-white px-4 py-2">Add</a>
<div class="row mt-3">
    <div class="col-md-12">
       <!-- table start -->
...
<tr>
    ...
    <td>
    <a href="edit_staff.php?id=<?=$state['id']?>" id="ed-icon"><i class="fa-solid fa-pen-to-square"></i></a>
    <a href="delete_staff.php?id=<?=$state['id']?>" id="del-icon"><i class="fa-solid fa-trash"></i></a>
    </td>
</tr>
<?php
$i++;
