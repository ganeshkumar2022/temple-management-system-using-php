...
<div class="card">
<div class="card-body">
<a href="add_user.php" class="btn button-color text-white px-4 py-2">Add user</a>
<div class="row mt-3">
    <div class="col-md-12">
       <!-- table start -->
...
<tr>
    ...
    <td><?=$state["role"]?></td>
    <td>
    <a href="edit_user.php?id=<?=$state['user_id']?>" id="ed-icon"><i class="fa-solid fa-pen-to-square"></i></a>
    &nbsp;&nbsp;
    <a href="delete_user.php?id=<?=$state['user_id']?>" id="del-icon"><i class="fa-solid fa-trash"></i></a>
    </td>
</tr>
<?php
$i++;
